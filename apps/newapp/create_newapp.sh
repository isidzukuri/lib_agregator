...
grep -rl "Newapp" "../$1" | xargs sed -i '' "s/Newapp/${capitalized_name}/g"
# echo "Find and replacing Newapp with $2"
# grep -rl "Newapp" "../$1" | xargs sed -i '' "s/Newapp/$2/g"

echo "Find and replacing newapp with $1"
grep -rl "newapp" "../$1" | xargs sed -i '' "s/newapp/$1/g"
