module WebParser
  class Parser < Initializator
    ...
    def extract_data(_page)
      raise NoMethodError, 'Implement this method in ur lib'
    end

    def extract_text(_data, _page, _agent)
      raise NoMethodError, 'Implement this method in ur lib'
    end

    def extract_img(_data, _page, _agent)
      raise NoMethodError, 'Implement this method in ur lib'
    end
    ...
    def abort_save(data, url = false)
      ...
      data.item.delete
      raise WebParserException, "Something went wrong with page #{url}"
    end
  end
end
